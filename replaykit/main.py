...
app = typer.Typer(help="ReplayKit - Record and replay mouse, keyboard, and scroll actions")
console = Console()
...
class ActionRecorder:
    ...
    def start_recording(self):
        ...
        self.recording = True
        self.ctrl_pressed = False
        console.print("[green]Recording started! Press Ctrl+Esc to stop recording.[/green]")
    ...
    def add_action(self, action_type: str, x: int = 0, y: int = 0, button: str = None, scroll_dx: int = 0, scroll_dy: int = 0, key: str = None):
        ...
        if action_type == "click":
            ...
            console.print(f"  [{elapsed_time:.2f}s] Scroll at ({x}, {y}) dx={scroll_dx} dy={scroll_dy}")
...
def record(
    ...
    console.print(f"[blue]Duration: {recording_data['total_duration']:.2f} seconds[/blue]")
...
def play(
    input_file: Path = typer.Argument(
        ...,
        help="Path to the recording file to play"
    ),
    ...
    loops: int = typer.Option(
        ...
        "--loops",
        "-n",
        help="Number of times to loop (0 for infinite)"
    ),
    ...
    delay: float = typer.Option(
        ...
        "--delay",
        "-d",
        help="Delay in seconds between loops"
    )
):
    """
    ...
    console.print(f"Recording: [yellow]{recording_data.get('name', 'Unknown')}[/yellow]")
    console.print(f"Actions: [blue]{len(actions)}[/blue]")
    console.print(f"Duration: [blue]{recording_data.get('total_duration', 0):.2f}s[/blue]")
...
def list_recordings(
    directory: Path = typer.Option(
        ...
        "--directory",
        "-d",
        help="Directory to list recordings from"
    )
):
    """
